	...
	Fathom.prototype = {
		...
		_setupTimeline: function() {
			...
			function parseTime(point) {
				for(var m = (point.time || point).toString().match(/(((\d+):)?(\d+):)?(\d+)/), a = 0, i = 3; i <= 203="" 250="" 360="" 1000="" 5;="" i++)="" {="" a="(a" *="" 60)="" +="" parseint(m[i]="" ||="" 0);="" }="" return="" a;="" var="" currentslide="-1;" function="" parseslide(point)="" if(="" point.slide="=" null="" )="" currentslide++;="" else="" if($.type(point.slide)="==" 'number')="" else{="" for(var="" match="slides.filter(" )[0],="" i="0;" <="" slides.length;="" i++="" slides[i]="==" break;="" slides.eq(="" );="" if(!="" this.config.timeline)="" this;="" this._timeline="[];" t="this.config.timeline," t.length;="" this._timeline.push({="" time:="" parsetime(="" t[i]="" ),="" slide:="" parseslide(="" });="" this._timeline.push(="" 99999,="" t[0].slide="" },="" _setupvideo:="" function()="" !this.config.video="" this._setupdefaulttimesource();="" this.config.video.source="==" "vimeo"="" this._setupvimeovideo(="" this.config.video="" throw="" "unknown="" video="" source,="" not="" supported";="" _setupdefaulttimesource:="" self="this," t0="(new" date()).gettime();="" setinterval(function()="" t1="(new" self.settime(="" (t1="" -="" t0)="" _setupvimeovideo:="" function(vid)="" vid="this.config.video," downgrade="false;" if(window.location.protocol="==" "file:")="" (="" "console"="" in="" window="" &&="" console.log("vimeo="" player="" api="" does="" work="" with="" local="" files.="" downgrading="" support\nsee="" http:="" vimeo.com="" docs="" player-js");="" loadframe()="" id="p" vid.id;="" framesrc="<iframe id=\" "="" "\"="" width="\""+" vid.width="" height="\""" (vid.height="" frameborder="\"0\"" src="\"http://player.vimeo.com/video/"" vid.id="" "?api="1&player_id="">";
